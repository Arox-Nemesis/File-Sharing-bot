...
def start_button(client):
    if not FORCE_SUB_CHANNEL and not FORCE_SUB_CHANNEL_2 and not FORCE_SUB_GROUP:
        buttons = [
            [
        ...
        return buttons
    if not FORCE_SUB_CHANNEL and not FORCE_SUB_CHANNEL_2 and FORCE_SUB_GROUP:
        buttons = [
            [
     ...
     if not FORCE_SUB_CHANNEL and FORCE_SUB_CHANNEL_2 and not FORCE_SUB_GROUP:
        ...
        return buttons
    if FORCE_SUB_CHANNEL and not FORCE_SUB_CHANNEL_2 and not FORCE_SUB_GROUP:
        buttons = [
            [
